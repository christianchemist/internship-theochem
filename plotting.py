...
energies_a_bases = np.array([0]) # calculation not done yet
energies_c_bases = np.array([3.794, 3.798, 3.803, 3.806, 3.808, 3.958, 3.969, 3.979, 3.980, 3.982, 3.982, 3.983])
energies_g_bases = np.array([3.687, 3.788, 3.792, 3.797, 3.800, 3.976, 3.985, 3.987, 3.989, 3.990, 3.992, 4.028])
energies_t_bases = np.array([3.789, 3.801, 3.814, 3.817, 3.829, 3.972, 3.975, 3.977, 3.981, 3.985, 3.987, 3.994])
